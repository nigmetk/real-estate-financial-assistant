...
"""
        ...
        if IS_PROD:
            ...
            # -----------------------------
            # CLOUD DEMO MODE — SMART ANSWERS
            # -----------------------------
            q = question.lower()

            if "net income" in q or "income" in q or "quarter" in q:
                answer = (
                    "Demo Mode: Last quarter's sample net income was approximately "
                    "$450,000 based on placeholder financial data."
                )

            elif "chicago" in q or "industrial" in q or "revenue" in q:
                answer = (
                    "Demo Mode: Sample Chicago industrial properties:\n"
                    "- 123 Main St — Revenue: $1.2M, Net Income: $450k\n"
                    "- 12 Warehouse Ln — Revenue: $1.8M, Net Income: $610k"
                )

            elif "press" in q or "announcement" in q or "acquisition" in q:
                answer = (
                    "Demo Mode: The company recently announced a sample acquisition "
                    "of a logistics facility to expand its industrial portfolio."
                )

            else:
                answer = (
                    "Demo Mode: This is a simulated AI response. Vertex AI is disabled "
                    "on Streamlit Cloud, but the full version would analyze your "
                    "question using real financial data and LLM tools."
                )
